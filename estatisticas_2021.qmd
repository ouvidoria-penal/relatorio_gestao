# Parâmetros 2021 {#sec-dados-ouvidoria-2021}
...
São analisados - numericamente e graficamente - os seguintes aspectos: características dos processos recebidos ([seção @sec-caracteristicas-processos-2021]); demandas tipificadas como solicitações ([seção @sec-solicitacoes-2021]); denúncias ([seção @sec-denuncias-2021]); reclamações ([seção @sec-reclamacoes-2021]); sugestões ([seção @sec-sugestoes-2021]); e elogios ou agradecimentos ([seção @sec-elogios-2021]). 

Para ampliar o poder de visualização do trabalho, a metodologia de coleta de dados foi melhorada e novas informações foram agregadas em 2021. Como resultado, têm-se informações sobre a forma como os usuários acessam a ouvidoria ([seção @sec-meios-acesso-ouvidoria-2021]); sobre a aptidão e tratamento dos requerimentos ([seção @sec-aptidao-2021]); e sobre evolução dos índices gerados para controle do tempo de atendimento dos processos ([seção @sec-tempos-2021]). Para o restante do quesitos, manteve-se a metodologia de análise das informações.
